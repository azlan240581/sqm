...
<title>Member Banners</title>
</head>

<body>
<div class="container">
<h2>Member Banners</h2>
<p>Get banner list : Introduction and Highlights.</p>
<p><strong>URL : <?= (isset($_SERVER['HTTPS'])?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/cmp/server/api/member-banners' ?></strong></p>

<form id="test" name="test" method="post" enctype="multipart/form-data" action="/cmp/server/api/member-banners">
