...
<title>Public News Feeds</title>
</head>

<body>
<div class="container">
<h2>Public News Feeds</h2>
<p>Get news feeds list.</p>
<p><strong>URL : <?= (isset($_SERVER['HTTPS'])?'https':'http').'://'.$_SERVER['HTTP_HOST'].'/cmp/server/api/public-news-feeds' ?></strong></p>

<form id="test" name="test" method="post" enctype="multipart/form-data" action="/cmp/server/api/public-news-feeds">
