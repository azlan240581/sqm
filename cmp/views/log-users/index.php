...
/* @var $searchModel app\models\LogUsersSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Users';
$this->params['breadcrumbs'][] = 'Reports';
$this->params['breadcrumbs'][] = 'Logs';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['/log-users']];
?>
<div class="log-users-index">
    <p>
		...
		if(isset($_GET['LogUsersSearch']))
		$exportExcelLink = array_merge($exportExcelLink,$_GET['LogUsersSearch']);
		echo Html::a('Export Excels', $exportExcelLink, ['class' => 'btn btn-success']); 
		?>
        <!--<button onclick="printContent('divLogUsersIndex')" class="btn btn-primary">Print this page</button>-->
