...
/* @var $model app\models\CollateralsMediasSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="collaterals-medias-search">
    ...
    <?= $form->field($model, 'collateral_id') ?>

    <?= $form->field($model, 'collateral_media_type_id') ?>
