...
<div class="prospects-view">
    ...
    <div class="input-group">
        <span class="input-group-addon" style="padding:0 !important;"><button title="Add" class="btn btn-md" style="margin:0 !important;"><span class="glyphicon glyphicon-plus"></span></button></span>
        <span class="input-group-addon" style="padding:0 15px !important; width:100%">
        <div class="row five-cols">
        <div class="col-sm-12 col-md-12"><?= Html::a('Follow Up', ['create-follow-up', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-default btn-sm followup modal-button-01']) ?></div>
        <div class="col-sm-12 col-md-12"><?= Html::a('Appointment Scheduled', ['create-appointment-scheduled', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-default btn-sm appointment modal-button-01']) ?></div>
        <div class="col-sm-12 col-md-12"><?= Html::a('Level of Interest', ['create-level-interest', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-default btn-sm levelinterest modal-button-01']) ?></div>
        <div class="col-sm-12 col-md-12"><?= Html::a('EOI', ['create-eoi', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-default btn-sm eoi modal-button-01']) ?></div>
        <div class="col-sm-12 col-md-12"><?= Html::a('Booking', ['create-booking', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-default btn-sm book modal-button-01']) ?></div>
        </div>
        </span>
        <?php /*?><span class="input-group-addon" style="padding:0 !important;"><?= Html::a('<span class="glyphicon glyphicon-share"></span>', ['share-prospect', 'id' => $model->id, 'ajaxView' => ''], ['class'=>'btn btn-md btn-primary share modal-button-01','style'=>'margin:0;','title'=>'Share Prospect']) ?></span><?php */?>
    </div>
    ...
    <tbody>
        ...
        <tr>
			...
			{
				case 1:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-eoi','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-view modal-button-01']);
					//echo Html::a('<button class="btn btn-sm btn-primary">Edit</button>&nbsp&nbsp', ['edit-eoi','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-update modal-button-01']);
					//echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 2:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-eoi','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-view modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-primary">Edit</button>&nbsp&nbsp', ['edit-eoi','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-update modal-button-01']);
				...
				case 3:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-eoi','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-view modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-success">Booking</button>&nbsp&nbsp', ['eoi-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'eoi-book modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 4:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'book-view modal-button-01']);
					//echo Html::a('<span class="glyphicon glyphicon-pencil"></span>&nbsp&nbsp', ['edit-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'book-update modal-button-01']);
					//echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 5:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'book-view modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-primary">Edit</button>&nbsp&nbsp', ['edit-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'book-update modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 6:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'book-view modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-primary">Contract Signed</button>&nbsp&nbsp', ['update-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'update-contract-signed modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 7:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'contract-signed-view modal-button-01']);
					//echo Html::a('<span class="glyphicon glyphicon-pencil"></span>&nbsp&nbsp', ['edit-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'contract-signed-update modal-button-01']);
					//echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 8:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'contract-signed-view modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-primary">Edit</button>&nbsp&nbsp', ['edit-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'contract-signed-update modal-button-01']);
					echo Html::a('<button class="btn btn-sm btn-danger">Cancel</button>&nbsp&nbsp', ['cancel-booking','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'cancel-booking modal-button-01']);
				break;
				case 9:
					echo Html::a('<button class="btn btn-sm btn-warning">View</button>&nbsp&nbsp', ['view-contract-signed','ajaxView'=>'','id'=>$model->id,'prospect_booking_id'=>$booking->id], ['class'=>'contract-signed-view modal-button-01']);
    ...
    <tbody>
        ...
        <tr>
			...
			. 
			(!empty($log['bookingid']) && in_array($log['history_id'],array(5,6,7,8,9,10,11,12,13))?'<div>Booking ID ('.$log['bookingid'].')'.'</div>':'')
			?>
            </td>
...
$(function(){
	...
	$('.drop-interest').click(function (){
		$('#modal-id-01').modal('show');
		$('#modal-id-01').find('#modal-content-01').load($(this).attr('value'));
		$('#modal-id-01').find('#modal-header-01').html("<?= 'Drop Interest for Prospect: '.$model->prospect_name.' ('.$model->prospect_contact_number.')' ?>");
	});
...
$('#modal-id-01').on('hidden.bs.modal', function () {
	alert('asdasd');
    //location.reload();
});
</script>
