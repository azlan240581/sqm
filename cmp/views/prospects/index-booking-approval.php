...
$this->title = 'Pending Booking Approval';
			...
			[
				...
				'buttons' => [
					'view-booking-approval' => function ($url, $model) {
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>&nbsp&nbsp', ['view-booking-approval', 'prospect_booking_id' => $model->id, 'id'=> $model->prospect_id],['class'=>'modal-button-01']);
					},
...
<?php
Modal::begin([
	'header' => '<h4 id="modal-header-id-01">View Prospect Booking</h4>',
	'id' => 'modal-id-01',
	'size' => 'modal-lg',
