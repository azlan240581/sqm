...
$this->title = 'Pending Contract Signed Approval';
    ...
    <?= GridView::widget([
        ...
        'columns' => [
			...
			[
				...
				'buttons' => [
					'view-booking-approval' => function ($url, $model) {
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>&nbsp&nbsp', ['view-contract-signed-approval', 'prospect_booking_id' => $model->id, 'id'=> $model->prospect_id],['class'=>'modal-button-01']);
					},
...
<?php
Modal::begin([
	'header' => '<h4 id="modal-header-id-01">View Contract Signed</h4>',
	'id' => 'modal-id-01',
	'size' => 'modal-lg',
