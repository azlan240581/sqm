    ...
    <?= GridView::widget([
        ...
        'columns' => [
			...
			[
				...
				'buttons' => [
					'view-admin' => function ($url, $model) {
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>&nbsp&nbsp', ['view-admin', 'id' => $model->id]);
					},
					...
					'delete' => function ($url, $model) {
						if($model->status == 1)
						return Html::a('<span class="glyphicon glyphicon-trash"></span>&nbsp&nbsp', ['delete', 'id' => $model->id], ['data' => ['confirm' => 'Are you sure you want to delete this prospect?','method' => 'post']]);
						else
						return '';
					},
				],
