...
/* @var $searchModel app\models\PotentialAssociatesSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Potential Associates';
$this->params['breadcrumbs'][] = 'Associates Management';
$this->params['breadcrumbs'][] = ['label' => $this->title, 'url' => ['/potential-associates']];
?>
<div class="potential-associates-index">
    <p>
    </p>
	...
	<?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                'attribute' => 'status',
                'filter'=>ArrayHelper::map(array(array('value'=>'1','name'=>'Registered'),array('value'=>'0','name'=>'New')), 'value', 'name'),
                'value' => function($model){
                            return $model->status==0?'New':'Registered';
                        },
            ],
            [
