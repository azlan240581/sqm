        ...
        <div class="panel-body">
            ...
            <?= DetailView::widget([
                ...
                'attributes' => [
                    ...
                    [
                        'label'=>$modelUserAssociateDetails->getAttributeLabel('id_number'),
						'value'  => $modelUserAssociateDetails->id_number,
					],
                    [
                        'label'=>$modelUserAssociateDetails->getAttributeLabel('tax_license_number'),
						'value'  => $modelUserAssociateDetails->tax_license_number,
					],
					[
						'label' => 'Bank',
